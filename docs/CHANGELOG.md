...
- Aligned Admin module dispatch and public `admin()` discovery with one-character module slugs, allowing service modules such as `s` to expose their authorized administration interface
